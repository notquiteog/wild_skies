...
Gen 2 maps, and omit neighbours without a loaded tileset. This prevents the
number-indexing defCellTile error during flock updates. Include original MIT
license and upstream1.12.1 missing-player-cell fix. Native seam test:11/11.
